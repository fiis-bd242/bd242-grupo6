...
| **COD_SUCURSAL**     | INT        | 99999999    | 8 dígitos                             | ---    | ---         | Identificador de la sucursal a la que está asignado el oficial de crédito. | Identifica la sucursal del oficial.   |
...
| **COD_SUCURSAL**    | INT        | 999999      | NO NULO                        | ---    | Analista_Credito | Código de la sucursal asignada al analista.               | Identifica la sucursal del analista.   |
...
| **COD_SUCURSAL**       | INT        | 99999999   | 8 dígitos             | ---    | ---         | Identificador de la sucursal asignada al analista.     | Identifica la sucursal del analista.  |
...
| Atributo                     | Naturaleza   | Formato      | Valores Válidos  | Unidad | Derivada de | Semántica                                               | Ontología                                                |
|------------------------------|--------------|--------------|------------------|--------|-------------|--------------------------------------------------------|---------------------------------------------------------|
| **ID_SOLICITANTE**           | PK VARCHAR(8)| ---          | 8 caracteres      | ---    | ---         | Identificador único del solicitante.                   | Permite identificar y gestionar solicitudes de forma única. |
| **NOMBRE_SOL**               | VARCHAR(15)  | ---          | NO NULO          | ---    | ---         | Nombre del solicitante.                                | Necesario para personalizar la comunicación y documentación. |
| **RUC_SOL**                  | CHAR(11)     | ---          | NO NULO          | ---    | ---         | Registro Único de Contribuyente.                       | Requisito legal para el registro de distribuidores.        |
| **UBICACION_SOL**            | VARCHAR(40)  | ---          | NO NULO          | ---    | ---         | Dirección del solicitante.                             | Facilita la logística y la verificación de ubicación.       |
| **CORREO_ELECTRONICO_SOL**   | VARCHAR(40)  | ---          | NO NULO          | ---    | ---         | Correo electrónico del solicitante.                    | Canal de comunicación importante para notificaciones.       |
| **TELEFONO_SOL**             | CHAR(9)      | ---          | ---              | ---    | ---         | Número de teléfono del solicitante.                    | Proporciona un medio de contacto directo.                   |
...
| Atributo                     | Naturaleza   | Formato      | Valores Válidos  | Unidad | Derivada de | Semántica                                               | Ontología                                                |
|------------------------------|--------------|--------------|------------------|--------|-------------|--------------------------------------------------------|---------------------------------------------------------|
| **ID_SOLICITUD**             | PK VARCHAR(10)| ---         | 10 caracteres     | ---    | ---         | Identificador único de la solicitud.                   | Permite rastrear y gestionar el proceso de solicitud.      |
| **FECHA_SOLICITUD**          | DATE         | ---          | NO NULO          | ---    | ---         | Fecha en que se realizó la solicitud.                  | Importante para el seguimiento y plazos del proceso.       |
| **ESTADO**                   | VARCHAR(10)  | ---          | NO NULO          | ---    | ---         | Estado actual de la solicitud.                         | Indica en qué etapa se encuentra la solicitud.             |
| **ID_SOLICITANTE**           | FK VARCHAR(8)| ---          | NO NULO          | ---    | SOLICITANTE | Identificador del solicitante (FK).                    | Establece la relación entre la solicitud y el solicitante.  |
| **ID_ANALISTA_ADM**          | FK VARCHAR(9)| ---          | ---              | ---    | ANALISTA ADM | Identificador del analista que evalúa la solicitud (FK). | Relaciona la solicitud con el analista encargado.           |
...
| Atributo                     | Naturaleza   | Formato      | Valores Válidos  | Unidad | Derivada de | Semántica                                               | Ontología                                                |
|------------------------------|--------------|--------------|------------------|--------|-------------|--------------------------------------------------------|---------------------------------------------------------|
| **ID_ANALISTA_ADM**          | PK VARCHAR(9)| ---          | 9 caracteres      | ---    | ---         | Identificador único del analista.                      | Permite rastrear y gestionar las revisiones de solicitudes. |
| **NOMBRE_AD**                | VARCHAR(15)  | ---          | NO NULO          | ---    | ---         | Nombre del analista.                                   | Facilita la identificación y comunicación con el analista.  |
| **CORREO_ELECTRONICO_AD**    | VARCHAR(40)  | ---          | NO NULO          | ---    | ---         | Correo electrónico del analista.                       | Importante para la coordinación de la revisión.            |
| **TELEFONO_AD**              | CHAR(9)      | ---          | ---              | ---    | ---         | Número de teléfono del analista.                       | Proporciona un medio de contacto directo.                   |
...
| Atributo                     | Naturaleza   | Formato      | Valores Válidos  | Unidad | Derivada de | Semántica                                               | Ontología                                                |
|------------------------------|--------------|--------------|------------------|--------|-------------|--------------------------------------------------------|---------------------------------------------------------|
| **ID_DOCUMENTO**             | PK VARCHAR(13)| ---         | 13 caracteres     | ---    | ---         | Clave primaria del documento.                          | Permite gestionar y verificar la documentación presentada. |
| **TIPO_DOC**                 | VARCHAR(20)  | ---          | NO NULO          | ---    | ---         | Tipo de documento (Ej: Estado Financiero, Licencia).   | Clasifica la documentación necesaria para el proceso.      |
| **RUTA_DOC**                 | VARCHAR(40)  | ---          | NO NULO          | ---    | ---         | Ruta donde se almacena el documento.                   | Facilita el acceso y revisión de la documentación.         |
| **ID_SOLICITUD**             | FK VARCHAR(10)| ---         | NO NULO          | ---    | SOLICITUD   | Clave foránea a la tabla Solicitud.                    | Relaciona los documentos con la solicitud correspondiente.  |
