...
| Atributo              | Naturaleza | Formato    | Valores Válidos       | Unidad | Derivada de | Semántica                                               | Ontología                             |
|-----------------------|------------|------------|-----------------------|--------|-------------|--------------------------------------------------------|---------------------------------------|
| **COD_SOLICITANTE**     | INT        | 999999999  | 9 dígitos             | ---    | ---         | Identificador único del solicitante.                   | Permite identificar y gestionar solicitudes de forma única. |
...
| Atributo              | Naturaleza | Formato    | Valores Válidos       | Unidad | Derivada de | Semántica                                               | Ontología                             |
|-----------------------|------------|------------|-----------------------|--------|-------------|--------------------------------------------------------|---------------------------------------|
| **COD_SOLICITUD**       | INT        | 999999999  | 9 dígitos             | ---    | ---         | Identificador único de la solicitud.                   | Permite rastrear y gestionar el proceso de solicitud. |
...
| **COD_SOLICITANTE**     | INT        | 999999999  | NO NULO               | ---    | SOLICITANTE | Identificador del solicitante (FK).                    | Establece la relación entre la solicitud y el solicitante. |
| **COD_ANALISTA_ADM**    | INT        | 999999999  | ---                   | ---    | ANALISTA ADMISION | Identificador del analista que evalúa la solicitud (FK). | Relaciona la solicitud con el analista encargado. |
...
| Atributo              | Naturaleza | Formato    | Valores Válidos       | Unidad | Derivada de | Semántica                                               | Ontología                             |
|-----------------------|------------|------------|-----------------------|--------|-------------|--------------------------------------------------------|---------------------------------------|
| **COD_DOCUMENTO**       | INT        | 999999999  | 9 dígitos             | ---    | ---         | Identificador único del documento.                      | Permite gestionar y verificar la documentación presentada. |
...
| **COD_SOLICITUD**       | INT        | 999999999  | NO NULO               | ---    | SOLICITUD   | Identificador de la solicitud asociada (FK).            | Relaciona los documentos con la solicitud correspondiente. |
...
| Atributo              | Naturaleza | Formato    | Valores Válidos       | Unidad | Derivada de | Semántica                                               | Ontología                             |
|-----------------------|------------|------------|-----------------------|--------|-------------|--------------------------------------------------------|---------------------------------------|
| **COD_ANALISTA_ADM**    | INT        | 999999999  | 9 dígitos             | ---    | ---         | Identificador único del analista.                      | Permite rastrear y gestionar las revisiones de solicitudes. |
