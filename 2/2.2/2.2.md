...
|-----------|---------------------------------------------------|-----------------------------------------------------------------------------------------------------|------------------------------|
| 1         | Recibir notificación de resolución del contrato   | El analista de créditos y cobranzas recibe la notificación de resolución de contrato.                | Analista de Créditos (AC)     |
| 2         | Derivar al sistema automático                     | Soporte operacional y comisiones deriva la información recibida del analista al sistema automático.  | Soporte Operacional (SO)      |
...
| 5         | Emitir pre-liquidación con deudas y comisiones    | El analista emite la pre-liquidación de los saldos deudores/acreedores.                              | Analista de Créditos (AC)     |
| 6         | Revisar y reajustar pre-liquidación               | Si el distribuidor tiene observaciones, el analista realiza los ajustes necesarios.                  | Analista de Créditos (AC)     |
| 7         | Emitir liquidación final                          | Una vez ajustada o sin observaciones, se genera la liquidación final de los saldos pendientes.       | Analista de Créditos (AC)     |
