...
<div align="center">
<a>
    <img src="https://github.com/fiis-bd242/bd242-grupo6/blob/main/src/BMPN%20TO%20BE%20-%20modulo%201.png?raw=true" alt="Logo" width="450" style=" padding-right: 60px;">
</a>
</div>
...
<div align="center">
<a>
    <img src="https://github.com/fiis-bd242/bd242-grupo6/blob/main/src/RECARGAS-TO-BE1.png?raw=true" alt="Logo" width="450" style=" padding-right: 60px;">
</a>
</div>
...
<div align="center">
<a>
    <img src="https://github.com/fiis-bd242/bd242-grupo6/blob/main/src/ADMISION%20DISTRIBUIDORES%20TO-BE.png?raw=true" alt="Logo" width="450" style=" padding-right: 60px;">
</a>
</div>

| Secuencia | Actividad                          | Descripción                                                                                                   | Responsable                       |
|-----------|------------------------------------|---------------------------------------------------------------------------------------------------------------|-----------------------------------|
| 1         | Recepción de Solicitud             | El distribuidor potencial envía una solicitud de admisión al sistema.                                         | Distribuidor / Sistema            |
...
| 4         | Generación de Informe de Evaluación | Se genera un informe con los resultados de la evaluación, incluyendo recomendaciones.                         | Sistema                           |
| 5         | Revisión del Informe               | El informe generado es revisado por el equipo de gestión.                                                   | Gerencia de Distribuidores        |
| 6         | Toma de Decisión                   | Se toma la decisión sobre la admisión del distribuidor basándose en el informe de evaluación.                | Gerencia de Distribuidores        |
| 7         | Notificación de Resultado          | Se notifica al distribuidor el resultado de la evaluación y la decisión tomada.                               | Sistema                           |
| 8         | Generación de Contrato            | Si la admisión es aprobada, se genera el contrato para el distribuidor.                                      | Departamento Legal / Sistema      |
| 9         | Firma del Contrato                 | El distribuidor revisa y firma digitalmente el contrato.                                                     | Distribuidor / Sistema            |
...
| 11        | Capacitación del Distribuidor       | Se organiza una sesión de capacitación sobre el uso del sistema y los procesos relacionados.                  | Coordinador de Capacitación       |
