...
CREATE TABLE Pedido (
    ...
    ESTADO_PEDIDO VARCHAR(10) CHECK (ESTADO_PEDIDO IN ('Aceptado', 'Rechazado')) NOT NULL,
    METODO_PAGO VARCHAR(10) CHECK (METODO_PAGO IN ('Crédito', 'Contado', 'Transferencia')) NOT NULL,
    OBSERVACIONES TEXT,
    TIPO_PEDIDO VARCHAR(10) CHECK (TIPO_PEDIDO IN ('Equipo', 'Recarga')) NOT NULL,
    COD_NOTIFICACION VARCHAR(10),
    FOREIGN KEY (COD_CLIENTE) REFERENCES clientes(COD_CLIENTE),
    FOREIGN KEY (COD_NOTIFICACION) REFERENCES notificaciones(COD_NOTIFICACION)
);
...
CREATE TABLE RECARGA (
    ...
    ESTADO_RECARGA VARCHAR(10) NOT NULL CHECK (ESTADO_RECARGA IN ('Aceptado', 'Rechazado')),
...
CREATE TABLE Analista_admision (
    ...
    FOREIGN KEY (COD_SOL_ANALISTA_ADM) REFERENCES olicitud_Analista_admision(COD_SOL_ANALISTA_ADM)
);
