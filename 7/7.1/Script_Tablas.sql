...
CREATE TABLE Pedido (
    ...
    COD_CLIENTE VARCHAR(7) NOT NULL,  -- Ajustar el tamaño a 7 para coincidir con Cliente
    FECHA_REG_PEDIDO DATE NOT NULL,
    FECHA_EVALUACION DATE NOT NULL,
    ESTADO_PEDIDO VARCHAR(10) CHECK (ESTADO_PEDIDO IN ('Aceptado', 'Rechazado')) NOT NULL,
    METODO_PAGO VARCHAR(15) CHECK (METODO_PAGO IN ('Crédito', 'Contado', 'Transferencia')) NOT NULL,
